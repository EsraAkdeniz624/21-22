...
user.name = 'Testendgültig' # set to your user name
...
```{r "2"}
readLines("./data/EU_Makro1.csv",10)
readLines("./data/EU_Makro3.csv",10)
```
...
library(openxlsx)
read.xlsx("./data/EU_Makro2.xlsx",1)
```
...
```{r "2_d"}
eu_makro1 <- read.csv("./data/EU_Makro1.csv")
eu_makro2 <- read.xlsx("./data/EU_Makro2.xlsx")
eu_makro3 <- read.csv2("./data/eu_makro3.csv")
```
